...
"""Launch file for the Sliding Windows lane detection node."""
...
def generate_launch_description():
    pkg_share = get_package_share_directory('lane_detection_sliding_windows')
    default_params = os.path.join(pkg_share, 'config', 'sw_params.yaml')
